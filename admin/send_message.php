...
// Callback para enviar un mensaje a un thread
function send_message_thread_callback( WP_REST_Request $request ) {
    global $wpdb;
    ...
    if (empty($thread_id) || empty($sender_id) || empty($message)) {
